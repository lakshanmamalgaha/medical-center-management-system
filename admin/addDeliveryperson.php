						...
						if(Token::check(Input::get('token')) )
				{
					...
					if($validate->passed()){
						...
						try{
							...
							Redirect::to('deliveryperson.php');
						...
						<div class="content-wrapper">
							<div class="container-fluid">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="deliveryperson.php">Delivery Persons</a></li>
									<li class="breadcrumb-item">ADD Delivery Person</li>
								</ol>
						<?php
          ...
          <div class="container-fluid">
            <!-- Breadcrumbs-->
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="deliveryperson.php">Doctors</a></li>
							<li class="breadcrumb-item">ADD Delivery Person</li>
						</ol>';
      }
			?>
...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group">
			...
			<input type="submit" class="btn btn-primary btn-block" value="Add Delivery Person">
